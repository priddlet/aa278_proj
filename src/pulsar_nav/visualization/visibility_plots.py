...
def plot_orbit_colored_by_policy(
    ...
    *,
    ...
    ax.set_ylabel("y (km)")
    ax.set_zlabel("z (km)")
    ax.set_title(title or f"Orbit - {policy_display_name(policy)}")
...
def plot_policy_segment_timeline(
    ...
    *,
    ...
    ax.set_title(title or f"Segments - {policy_display_name(policy)}")
